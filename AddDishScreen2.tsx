...
/*This Screen allows the chef to add menu items to the Main Course. */

const AddDishScreen2: React.FC<{ navigation: any, route: any }> = ({ navigation, route }) => {
  ...
  const handleAddDish = () => {
    ...
    if (imageUri.startsWith('http') || imageUri.startsWith('https') || imageUri.startsWith('data')) {
      ...
      navigation.navigate('FilterSearchScreen2', { newDish });
