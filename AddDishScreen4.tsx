...
/*This Screen allows the chef to add menu items to the Drinks Course.*/

const AddDishScreen4: React.FC<{ navigation: any, route: any }> = ({ navigation, route }) => {
  ...
  const handleAddDish = () => {
    ...
    if (imageUri.startsWith('http') || imageUri.startsWith('https') || imageUri.startsWith('data')) {
      ...
      navigation.navigate('FilterSearchScreen4', { newDish });
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('AddDishScreen')}>
